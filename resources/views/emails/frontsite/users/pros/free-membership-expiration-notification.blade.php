       ...
       <tbody>
         ...
         <tr>
           <td style="letter-spacing: 3px; line-height: 31px; text-align: center; font-size:18px;  font-family: questrial , 'tahoma'; font-weight:400 ; color: #000000;">
             FREE TRIAL MEMBERSHIP EXPIRATION
           </td>
         </tr>
         ...
         <tr>
           <td style="line-height: 20px; text-align: center;  font-size:14px;  font-family: questrial , 'tahoma'; font-weight:400 ; color: #000000;">
             <!-- Great news! Your event has been approved! It's now posted and professionals will be able to view and bid on it. Good luck! -->
           </td>
         </tr>
                   ...
                   <tbody>
                     ...
                     <tr>
                       <td height="34" style="line-height: 34px;text-align:left; font-size:27px; font-family:'Playfair Display' , 'times new roman'; font-weight:700 ;  color: #ffffff ">
                         YOUR FREE TRIAL MEMBERSHIP HAS EXPIRED
                       </td>
                     </tr>
                     <tr>
                       <td height="8">
                     ...
                     <tr>
                       ...
                       If you need any help, feel free to <a href="{{route('frontsite.contact-us')}}" style="color:#ffa928; font-weight:600;">contact us</a> or visit our <a href="route('frontsite.faq')" style="color:#ffa928; font-weight:600;">FAQ page</a>.
                       </td>
                     </tr>
                     <tr>
                       <td height="22">
                           ...
                           <tbody>
                             <tr>
                               <td height="34" width="175" style="background: #ffffff;text-align:center; font-size:15px; font-family:'questrial' , tahoma; font-weight:400 ; color: #ac5474; ">
                                 <a href="{{route('frontsite.professionals.membership')}}" style="display: block; text-align:center; font-size:15px; font-family:'questrial' , tahoma; font-weight:400 ; color: #3592f1;  ">CLICK HERE TO RENEW/UPGRADE</a>
