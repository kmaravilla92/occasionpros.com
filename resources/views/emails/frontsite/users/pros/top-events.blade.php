     ...
     <table width="100%" cellspacing="0" cellpadding="0" border="0" align="left" style="mso-table-lspace:0pt; mso-table-rspace:0pt; margin: 0 auto; border-collaps:collaps;" class="mtitle">
       <tbody>
         ...
         <td style="line-height: 20px; text-align: center;  font-size:14px;  font-family: questrial , 'tahoma'; font-weight:400 ; color: #000000;">
           Hi {{ $data['pro_name'] }}, as a professional with a good reputation here's a list of top events which you can apply. Occasion Pros is your one-stop site for connecting professionals with clients looking for the
           best and talented event professionals in the US. Good luck and Happy Bidding!
         </td>
