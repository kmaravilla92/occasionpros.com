                   ...
                   <tbody>
                     ...
                     <tr>
                       <td height="34" style="line-height: 24px;text-align:left; font-size:14px; font-family: questrial , 'tahoma'; font-weight:300 ; color: #ffffff">
                         Your event has been successfully ended. You may now release the payment to provide a feedback to your professional.
                           ...
                           <tbody>
                             <tr>
                               <td height="34" width="175" style="background: #ffffff;text-align:center; font-size:15px; font-family:'questrial' , tahoma; font-weight:400 ; color: #ac5474; ">
                                 <a href="{{route('frontsite.clients.payment-info',['bid_id'=>$data['bid_id']])}}" style="display: block; text-align:center; font-size:15px; font-family:'questrial' , tahoma; font-weight:400 ; color: #3592f1;  ">RELEASE PAYMENT</a>
                               ...
                               <td height="34" width="175" style="background: #ffffff;text-align:center; font-size:15px; font-family:'questrial' , tahoma; font-weight:400 ; color: #ac5474; ">
                                 <a href="{{route('frontsite.clients.events.show',[$data['event']['uid']])}}" style="display: block; text-align:center; font-size:15px; font-family:'questrial' , tahoma; font-weight:400 ; color: #3592f1;  ">VIEW EVENT</a>
