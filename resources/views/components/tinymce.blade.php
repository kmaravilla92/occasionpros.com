...
@section('js_bottom')
    @parent
    <script src="/backoffice/plugins/tinymce_4.6.4/tinymce/js/tinymce/tinymce.min.js"></script>
    <script>
        ...
        function _saveImage(file,callback){
            var data = new FormData();
                ...
                $.ajax({
                    data: data,
                    type: 'POST',
                    url: '{{route('backoffice.cms.wysiwyg-image.upload')}}',
                    cache: false,
                    contentType: false,
                    processData: false
        ...
        $.extend(default_options,options_override);
